...
exports.WarmupAIFilterService = void 0;
class WarmupAIFilterService {
    static ROBOTIC_BLACKLIST = [
        'aqui está',
        'sou uma ia',
...
exports.WarmupAIFilterService = WarmupAIFilterService;
