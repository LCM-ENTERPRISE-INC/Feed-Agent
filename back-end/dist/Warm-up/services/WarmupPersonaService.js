...
exports.WarmupPersonaService = void 0;
class WarmupPersonaService {
    /**
     ...
     */
    static getReplyPrompt(incomingMessage, history = []) {
        let historyContext = '';
...
exports.WarmupPersonaService = WarmupPersonaService;
